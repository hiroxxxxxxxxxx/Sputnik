...
def build_signal_bundle(
    ...
    *,
    ...
    :param raw_provider: Layer 1 の取得窓口（例: CachedRawDataProvider）。
    ...
    price_signals: Dict[str, PriceSignals] = {
        sym: compute_price_signals(raw_provider, sym, as_of)
    ...
    cap_signals = compute_capital_signals(raw_provider, as_of)
